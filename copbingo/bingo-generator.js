...
const cells = [
	...
	"Robs store, leaves, returns",
	"Mentions mandatory PD yoga",
	"VCB in under 30 seconds",
	"Uses own firearm in robbery",
	...
	"Cop claims will be around more",
	"Air-1 head pops",
	"IS YOUR BODYCAM ON?",
